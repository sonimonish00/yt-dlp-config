...
$ytOptions = @(
    # --- Format Selection (360p-only, permissive on container) ---
    '-f', 'bestvideo[height<=360][ext=mp4]+bestaudio[ext=m4a]/best[height<=360][ext=mp4]/18',
    # 'worstvideo[ext=mp4]+worstaudio[ext=m4a]/worst',
